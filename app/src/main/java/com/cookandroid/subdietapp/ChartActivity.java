...
public class ChartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chart = (BarChart)findViewById(R.id.fragment_bluetooth_chat_barchart);
        ...
        set1 = new BarDataSet(yVals1, "kg");
        set1.setColor(Color.rgb(255, 145, 160));

        set2 = new BarDataSet(yVals2, "kcal");
